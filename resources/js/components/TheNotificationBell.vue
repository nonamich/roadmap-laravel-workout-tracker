      ...
      <div class="divide-y divide-gray-100 dark:divide-gray-700">
        ...
        >
          <div class="shrink-0">
            ...
            />
            <div
              class="absolute ms-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-blue-600 dark:border-gray-800"
            >
              <svg
        ...
        >
          <div class="shrink-0">
            ...
            />
            <div
              class="absolute ms-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-gray-900 dark:border-gray-800"
            >
              <svg
                class="h-2 w-2 text-white"
                aria-hidden="true"
        ...
        >
          <div class="shrink-0">
            ...
            />
            <div
              class="absolute ms-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-red-600 dark:border-gray-800"
            >
              <svg
                class="h-2 w-2 text-white"
                aria-hidden="true"
        ...
        >
          <div class="shrink-0">
            ...
            />
            <div
              class="absolute ms-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-green-400 dark:border-gray-800"
            >
              <svg
                class="h-2 w-2 text-white"
                aria-hidden="true"
        ...
        >
          <div class="shrink-0">
            ...
            />
            <div
              class="absolute ms-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-purple-500 dark:border-gray-800"
            >
              <svg
                class="h-2 w-2 text-white"
                aria-hidden="true"
